...
const Pagination = ({ page, maxPage, setPage }) => {
    ...
    const finalPages = maxBlock === currentBlock ? maxPage : currentBlock * pagesPerBlock

    for (let i = initialPage; i <= finalPages; i++) {
        arrPages.push(i)
    }
    ...
    return (
        <div className='pagination'>
            ...
            <ul className='pagination__list'>
                ...
                {
                    arrPages.map(e => (
                        <li className={`pagination__item ${page === e && 'page__active'}`} onClick={() => handlePages(e)} key={e}>{e}</li>
                    ))
                }
